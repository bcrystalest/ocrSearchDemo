...
//    self.navigationItem.r=ightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"闪光灯" style:UIBarButtonItemStylePlain target:self action:@selector(turnOnOrOffTorch)];
}
